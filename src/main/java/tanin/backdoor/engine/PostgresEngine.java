...
public class PostgresEngine extends Engine {
  ...
  @Override
  public BackdoorServer.SqlType getSqlType(String sql) throws SQLException {
    var sanitized = sql.toLowerCase().trim();
    if (sanitized.startsWith("explain")) {
      return BackdoorServer.SqlType.EXPLAIN;
    }
    ...
    if (
      ...
      return BackdoorServer.SqlType.ADMINISTRATIVE;
    }
    ...
    return isModifyingTable ? BackdoorServer.SqlType.MODIFY : BackdoorServer.SqlType.SELECT;
  }
