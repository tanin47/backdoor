...
[![Sonatype Central](https://maven-badges.sml.io/sonatype-central/io.github.tanin47/backdoor/badge.png?version=2.3.0-rc2)](https://central.sonatype.com/artifact/io.github.tanin47/backdoor)
...
```
java -jar backdoor-2.3.0-rc2.jar \
  -port 9999 \
...
1. Run `docker buildx build --platform linux/amd64,linux/arm64 -t backdoor:v2.3.0-rc2 .`
2. Test locally with:
   `docker run -p 9090:9090 --entrypoint "" backdoor:v2.3.0-rc2 java -jar backdoor-2.3.0-rc2.jar -port 9090`
3. Run: `docker tag backdoor:v2.3.0-rc2 tanin47/backdoor:v2.3.0-rc2`
4. Run: `docker push tanin47/backdoor:v2.3.0-rc2`
...
3. Test the docker with
   `docker run -p 9090:9090 --entrypoint "" tanin47/backdoor:v2.3.0-rc2 java -jar backdoor-2.3.0-rc2.jar -port 9090`.
