...
[![Sonatype Central](https://maven-badges.sml.io/sonatype-central/io.github.tanin47/backdoor/badge.png?version=2.7.0-rc1)](https://central.sonatype.com/artifact/io.github.tanin47/backdoor)
...
docker run -p 9999:9999 \
           --entrypoint "" \
           --pull always \
           tanin47/backdoor:web-2.7.0-rc1 \
           java -jar backdoor-2.7.0-rc1.jar \
           -port 9999 \
...
1. Run `docker buildx build --platform linux/amd64,linux/arm64 -t backdoor:web-2.7.0-rc1 .`
2. Test locally with:
   `docker run -p 9090:9090 --entrypoint "" backdoor:web-2.7.0-rc1 java -jar backdoor-2.7.0-rc1.jar -port 9090`
3. Run: `docker tag backdoor:web-2.7.0-rc1 tanin47/backdoor:web-2.7.0-rc1`
4. Run: `docker push tanin47/backdoor:web-2.7.0-rc1`
...
3. Test the docker with
   `docker run -p 9090:9090 --entrypoint "" tanin47/backdoor:web-2.7.0-rc1 java -jar backdoor-2.7.0-rc1.jar -port 9090`.
