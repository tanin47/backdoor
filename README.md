...
1. Run `docker buildx build --platform linux/amd64,linux/arm64 -t backdoor:web-2.3.0-rc4 .`
2. Test locally with:
   `docker run -p 9090:9090 --entrypoint "" backdoor:web-2.3.0-rc4 java -jar backdoor-2.3.0-rc4.jar -port 9090`
3. Run: `docker tag backdoor:web-2.3.0-rc4 tanin47/backdoor:web-2.3.0-rc4`
4. Run: `docker push tanin47/backdoor:web-2.3.0-rc4`
...
3. Test the docker with
   `docker run -p 9090:9090 --entrypoint "" tanin47/backdoor:web-2.3.0-rc4 java -jar backdoor-2.3.0-rc4.jar -port 9090`.
